...
btn_add = Button(root,text='+',bg='pink',fg='white',width=5,height=2,command=lambda :get_operator('+'))
...
btn_sub = Button(root,text='-',bg='pink',fg='white',width=5,height=2,command=lambda :get_operator('-'))
...
btn_mul = Button(root,text='x',bg='pink',fg='white',width=5,height=2,command=lambda :get_operator('x'))
...
btn_clr = Button(root,text='C',bg='pink',fg='white',width=5,height=2,command=lambda :clear())
btn_clr.grid(row=4,column=1)
btn_clr.config(font=('verdana',14))

btn_equals = Button(root,text='=',bg='pink',fg='white',width=5,height=2,command=get_result)
btn_equals.grid(row=4,column=2)
btn_equals.config(font=('verdana',14))

btn_div = Button(root,text='/',bg='pink',fg='white',width=5,height=2,command=lambda :get_operator('/'))
